import{r as b,a as t}from"./react-vendor-BIDOXFPG.js";import{B as J,aK as ee,t as ie,aJ as w,a as P}from"./index-CCUHZh2C.js";import{a as te}from"./query-vendor-CgIICZoo.js";import{u as oe}from"./useAlert-DoCjRLM9.js";import{t as se}from"./browser-BiSx3Vix.js";import{av as re,aA as A,ao as z,cB as j,az as T,O as U,X as O,a1 as G,d as le,Y as D,l as B,aG as ne,V as de,e as ae}from"./icons-vendor-XaiJmnGx.js";import{f as V}from"./format-B7HFsDA2.js";import"./export-libs-BvadkuZN.js";import"./socket-vendor-TjCxX7sJ.js";import"./motion-vendor-Cm2TDenC.js";import"./Modal-2Z2VxwEa.js";const s=e=>{const a={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return e.replace(/[&<>"']/g,l=>a[l]||l)},m=e=>{if(!e)return"---";try{const a=new Date(e);return`${a.getUTCFullYear()}/${String(a.getUTCMonth()+1).padStart(2,"0")}/${String(a.getUTCDate()).padStart(2,"0")}`}catch{return"---"}},pe=`
