...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log('Adding categoryId column to crm_tickets...');
            yield (0, db_1.safePoolQuery)('ALTER TABLE crm_tickets ADD COLUMN categoryId VARCHAR(36) NULL');
            ...
            if (err.code === 'ER_DUP_FIELDNAME') {
                ...
                console.error('Error adding column categoryId:', err);
            }
        }
        try {
            ...
            if (err.code === 'ER_DUP_FIELDNAME') {
                ...
                console.error('Error adding column appointment_date:', err);
            }
        }
        process.exit(0);
    });
