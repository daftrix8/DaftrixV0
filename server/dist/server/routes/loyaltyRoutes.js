...
router.get('/dashboard', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.getLoyaltyDashboard);
// Settings
router.get('/settings', (0, authMiddleware_1.requirePermission)('pos.access'), loyaltyController_1.getLoyaltySettingsAPI);
router.put('/settings', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.updateLoyaltySettingsAPI);
// Rules
router.get('/rules', (0, authMiddleware_1.requirePermission)('pos.access'), loyaltyController_1.getLoyaltyRules);
router.post('/rules', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.createLoyaltyRule);
router.put('/rules/:id', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.updateLoyaltyRule);
router.delete('/rules/:id', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.deleteLoyaltyRule);
// Manual point adjustment (admin only)
router.post('/adjust', (0, authMiddleware_1.requirePermission)('admin'), loyaltyController_1.adjustLoyaltyPoints);
