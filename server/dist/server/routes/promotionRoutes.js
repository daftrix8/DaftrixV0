...
router.get('/', (0, authMiddleware_1.requirePermission)('admin'), promotionController_1.getPromotions);
// Create a new promotion with rules
router.post('/', (0, authMiddleware_1.requirePermission)('admin'), promotionController_1.createPromotion);
// Update a promotion (and optionally replace rules)
router.put('/:id', (0, authMiddleware_1.requirePermission)('admin'), promotionController_1.updatePromotion);
// Archive a promotion (soft delete)
router.delete('/:id', (0, authMiddleware_1.requirePermission)('admin'), promotionController_1.archivePromotion);
// Promotion usage report
router.get('/report', (0, authMiddleware_1.requirePermission)('admin'), promotionController_1.getPromotionReport);
