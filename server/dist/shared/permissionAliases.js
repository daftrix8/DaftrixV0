...
exports.PERMISSION_ALIASES = {
    ...
    'crm.complaints.view': ['crm.view', 'crm.manage'],
    ...
    'crm.create': ['crm.leads.create', 'crm.activities.create'],
    'crm.edit': ['crm.leads.edit', 'crm.activities.edit', 'crm.pipeline.edit'],
    'crm.delete': ['crm.leads.delete', 'crm.activities.delete'],
    // ── Van Sales (expanded) ──
